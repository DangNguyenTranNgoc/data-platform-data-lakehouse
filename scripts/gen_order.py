...
CONVERT_DATA_DIR = os.path.join(DATA_DIR, 'converted')

PRODUCT_DF = pd.read_csv(os.path.join(CONVERT_DATA_DIR, 'olist_products_dataset.csv'))
ORDER_DF = pd.read_csv(os.path.join(CONVERT_DATA_DIR, 'olist_orders_dataset.csv'))
